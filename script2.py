...
train_emails = fetch_20newsgroups(categories = ['comp.sys.ibm.pc.hardware', 'rec.sport.hockey', 'rec.autos'], subset = 'train', shuffle = True, random_state = 108)
test_emails = fetch_20newsgroups(categories = ['rec.sport.baseball', 'rec.sport.hockey', 'rec.autos'], subset = 'test', shuffle = True, random_state = 108)
...
# When we change the categories the classifer does a worse job classifying the categories
